<?php
$naslov = "Najbolji PHP dokument na internetu - nastavak nastavka";
$autor  = "Tomislav Delač";
$opis   = "Ova stranica nadograđuje prethodnu vježbu tako da biramo pozadinsku temu, odaberemo sliku i po želji prikazujemo opis.";
$dozvoljeneTeme  = array("dark", "light");
$dozvoljeneSlike = array(
  "sunce"  => "img/malaslika1.jfif",
  "server" => "img/malaslika2.webp",
  "code"   => "img/malaslika3.webp"
);

// --- Ulaz (GET) s default vrijednostima ---
$temaKey  = isset($_GET["tema"]) && in_array($_GET["tema"], $dozvoljeneTeme) ? $_GET["tema"] : "dark";
$slikaKey = isset($_GET["slika"]) && isset($dozvoljeneSlike[$_GET["slika"]]) ? $_GET["slika"] : "sunce";
...
<body>
  <main class="wrap">
    ...
    <form method="get" action="vjezba2.3.php">
      <fieldset>
        <legend>Odaberi pozadinsku temu</legend>
      ...
      <fieldset>
        ...
        <select id="slika" name="slika">
          <option value="php"    <?php echo $slikaKey==="php"    ? "selected" : ""; ?>>Zalazak sunca</option>
          <option value="server" <?php echo $slikaKey==="server" ? "selected" : ""; ?>>Jezero u planinama</option>
          <option value="code"   <?php echo $slikaKey==="code"   ? "selected" : ""; ?>>Vodopadi</option>
        </select>
      </fieldset>
      ...
      <div class="row" style="margin-top:10px">
        ...
        <a class="btn" href="vjezba2.2.php">Natrag na prošlu vježbu</a>
      </div>
    </form>
